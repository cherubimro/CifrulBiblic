...
Dintre cele 19 perechi cu sens diferit dar aceeași isopsefie (verificate pe formele din manuscris Rahlfs 1935 și SBLGNT), cele mai semnificative teologic:

\begin{itemize}
  \item \textbf{ἅγιος} (sfânt) = 284 = \textbf{θεός} (Dumnezeu) --- \href{https://bibliaortodoxa.ro/carte.php?id=61\&cap=1\#16}{1 Petru 1:16} citează \href{https://bibliaortodoxa.ro/carte.php?id=47\&cap=11\#44}{Levitic 11:44}: \textit{«Fiți \textbf{sfinți}, pentru că Eu sunt \textbf{Sfânt}»}. Sfânt este Dumnezeu; sfințenia este de la Dumnezeu.

  \item \textbf{καθώς} (precum) = 1030 = \textbf{πῶλον} (mânzul) --- \href{https://bibliaortodoxa.ro/carte.php?id=35\&cap=12\#14}{Ioan 12:14} citează \href{https://bibliaortodoxa.ro/carte.php?id=82\&cap=9\#9}{Zaharia 9:9}: \textit{«Iisus, găsind un asin tânăr, a șezut pe el, \textbf{precum} este scris»}. Cuvântul care introduce citatul (\textbf{precum}) codifică numeric exact obiectul profeției (\textbf{mânzul}).

  \item \textbf{Ἰδοὺ} (iată) = 484 = \textbf{θεοῦ} (lui Dumnezeu) --- \href{https://bibliaortodoxa.ro/carte.php?id=53\&cap=1\#2}{Marcu 1:2} citează \href{https://bibliaortodoxa.ro/carte.php?id=43\&cap=40\#3}{Isaia 40:3}: \textit{«\textbf{Iată} Eu trimit îngerul Meu»} / \textit{«drepte faceți cărările \textbf{Dumnezeului} nostru»}. «Iată!» = «lui Dumnezeu»: cel care trimite este Dumnezeu.

  \item \textbf{ἐγενόμην} (M-am făcut) = 231 = \textbf{ὄνομα} (nume) [33 × 7] --- \href{https://bibliaortodoxa.ro/carte.php?id=70\&cap=10\#20}{Romani 10:20} citează \href{https://bibliaortodoxa.ro/carte.php?id=43\&cap=65\#1}{Isaia 65:1}: \textit{«\textbf{M-am făcut arătat} celor ce nu întrebau de Mine»} / \textit{«un neam care nu chema \textbf{numele} Meu»}. Revelarea (a deveni vizibil) = Numele lui Dumnezeu.
\end{itemize}
...
\begin{itemize}
  ...
  \item \textbf{Citarea fidelă a LXX}: din 271 de citate directe verificate verset cu verset pe formele din manuscris (SBLGNT + Rahlfs 1935; sursă citate: marginalia Nestle-Aland via BlueLetterBible), 195 (72\%) păstrează potriviri isopsefice, iar 19 conțin cuvinte cu \textbf{sens diferit} dar aceeași isopsefie --- de exemplu \textbf{ἅγιος} (sfânt) = 284 = \textbf{θεός} (Dumnezeu) în 1 Petru 1:16 ← Levitic 11:44
