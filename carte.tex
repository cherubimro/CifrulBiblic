...
\vspace{0.05cm}
{\color{primarydark}\scriptsize\sffamily znrl.zlfkl @ djf.ik\par}
...
\midrule
\textbf{Buricul} & ὀμφαλός (\textit{omphalos}) & Centrul vieții fetale --- legătura fizică mamă--copil & Hipocrate, \textit{De Natura Pueri} \\
