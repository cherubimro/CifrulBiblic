...
Zona efectivă: câteva sute de m², nu 14.000. Pentru a răsturna mesele și a alunga vânzătorii cu animalele (oi, boi, porumbei — \href{https://bibliaortodoxa.ro/carte.php?id=35\&cap=2\#15}{In 2:15}) dintr-o porțiune a unei colonade, \textbf{20--50 de oameni hotărâți} ar fi suficienți — exact în intervalul celor \textbf{70 (72) de ucenici} menționați de Luca (\href{https://bibliaortodoxa.ro/carte.php?id=49\&cap=10\#1}{Lc 10:1}).
...
\textbf{στρατηγὸς τοῦ ἱεροῦ} & căpetenia străjii Templului & \href{https://bibliaortodoxa.ro/carte.php?id=49\&cap=22\#4}{Lc 22:4}, \href{https://bibliaortodoxa.ro/carte.php?id=49\&cap=22\#52}{22:52} & comandantul pazei levitice \\
\bottomrule
\end{tabularx}
\end{center}

\textbf{Efectivul total}: o σπεῖρα (480--1000) condusă de un χιλίαρχος (comandant de 1000) + ὑπηρέται (poliția Templului) = \textbf{peste 1000 de oameni înarmați}. Nu trimiți o cohortă cu tribun pentru a aresta 12 oameni. Au nevoie de \textbf{Iuda} ca să-L identifice cu un sărut (\href{https://bibliaortodoxa.ro/carte.php?id=53\&cap=14\#44}{Mc 14:44}) — semn că Iisus era într-o \textbf{mulțime de ucenici}. Luca menționează \textbf{70 (72)} trimiși (\href{https://bibliaortodoxa.ro/carte.php?id=49\&cap=10\#1}{Lc 10:1}); după Înviere erau \textbf{~120} adunați (\href{https://bibliaortodoxa.ro/carte.php?id=26\&cap=1\#15}{Fapte 1:15}).

Ucenicii erau înarmați: «Doamne, iată \textbf{două săbii}» (μάχαιραι ... δύο), iar Iisus: «\textbf{De ajuns este}» (Ἱκανόν ἐστιν) (\href{https://bibliaortodoxa.ro/carte.php?id=49\&cap=22\#38}{Lc 22:38}). La arestare, Petru lovește cu sabia și taie urechea lui Malhus (\href{https://bibliaortodoxa.ro/carte.php?id=35\&cap=18\#10}{In 18:10}), iar Iisus îl oprește: «pune sabia în teacă» (\href{https://bibliaortodoxa.ro/carte.php?id=35\&cap=18\#11}{In 18:11}).
...
\begin{biblequote}
«Căci vă spun că trebuie să se împlinească în Mine Scriptura aceasta: \textbf{καὶ μετὰ ἀνόμων ἐλογίσθη} — \textit{și cu cei fărădelege a fost socotit}.» (\href{https://bibliaortodoxa.ro/carte.php?id=49\&cap=22\#37}{Luca 22:37}, citând \href{https://bibliaortodoxa.ro/carte.php?id=25\&cap=53\#12}{Isaia 53:12})
\end{biblequote}
...
\begin{enumerate}
  ...
  \item \textbf{Retragerea} (\href{https://bibliaortodoxa.ro/carte.php?id=53\&cap=11\#19}{Mc 11:19}; \href{https://bibliaortodoxa.ro/carte.php?id=52\&cap=21\#17}{Mt 21:17}): În fiecare seară, Iisus se retrage la Betania — în afara jurisdicției. Iuda va trăda tocmai locația de noapte.
...
Ironia narativă e și mai adâncă: unele manuscrise vechi ale lui Matei (\href{https://bibliaortodoxa.ro/carte.php?id=52\&cap=27\#16}{Mt 27:16--17}) dau numele complet — \textbf{Ἰησοῦς Βαραββᾶς} («Iisus Baraba»). Mulțimea din narațiune alege literal între doi oameni numiți \textbf{Iisus}, ambii «fii ai tatălui». Origen (sec.~III, \textit{Commentarii in Matthaeum} ad loc.) comenta că numele «Iisus» apărea în fața lui «Baraba» în manuscrise vechi, dar că mulți copiști l-au eliminat — considerând nepotrivit ca un criminal să poarte același nume cu Mântuitorul.
...
\section{Nunta din Cana: apa, vinul și Dionysos (In 2:1--11)}
...
\subsection{Isopsefia transformării}
...
\subsection{Vin = secret; piatră = Paște}
...
Vinul grecesc confirmă: \textbf{οἶνος} (oinos = vin) = 400 = \textbf{ת} (Tav), ultima literă ebraică — semnul desăvârșirii. La Cruce, Iisus va spune «\textbf{τετέλεσται}» — s-a desăvârșit (\href{https://bibliaortodoxa.ro/carte.php?id=35\&cap=19\#30}{In 19:30}).
...
Episodul \textbf{nu are paralelă la MacDonald} în literatura clasică greacă și nu conține cuvinte aramaice transliterate (spre deosebire de ταλιθα κουμ, εφφαθα, αββα). E construcție literară a lui Marcu bazată pe profeții VT. Luca omite complet blestemarea — o înlocuiește cu parabola smochinului neroditor (\href{https://bibliaortodoxa.ro/carte.php?id=49\&cap=13\#6}{Lc 13:6--9}).
...
\midrule
\textbf{שרש} (\textit{shoresh} = rădăcină) & 800 & בגב & \textbf{7} & judecată divină \\
\textbf{פרי} (\textit{peri} = rod) & 290 & וגמ & \textbf{49 = 7²} & judecată completă \\
\bottomrule
\end{tabularx}
\end{center}

Smochinul s-a uscat «\textbf{ἐκ ῥιζῶν}» (din rădăcini, \href{https://bibliaortodoxa.ro/carte.php?id=53\&cap=11\#20}{Mc 11:20}). Rădăcina prin Atbash = 7; rodul prin Atbash = 7². Iar totalul isopsefiei sandwich-ului marcian (Mc 11:12--14 + 15--17 + 20--21) = \textbf{74816 = 7 × 10688} — multiplu de 7.
