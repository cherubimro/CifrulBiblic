...
\begin{itemize}
  ...
  \item \textbf{Citarea fidelă a LXX}: din 271 de citate directe verificate verset cu verset pe formele din manuscris (SBLGNT + Rahlfs 1935; sursă citate: marginalia Nestle-Aland via BlueLetterBible), 195 (72\%) păstrează potriviri isopsefice, iar 21 conțin cuvinte cu \textbf{sens diferit} dar aceeași isopsefie --- de exemplu \textbf{ἅγιος} (sfânt) = 284 = \textbf{θεός} (Dumnezeu) în 1 Petru 1:16 ← Levitic 11:44
