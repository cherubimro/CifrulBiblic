...
Ironia narativă e și mai adâncă: unele manuscrise vechi ale lui Matei (\href{https://bibliaortodoxa.ro/carte.php?id=52\&cap=27\#16}{Mt 27:16--17}) dau numele complet — \textbf{Ἰησοῦς Βαραββᾶς} («Iisus Baraba»). Mulțimea alege literal între doi oameni numiți \textbf{Iisus}, ambii «fii ai tatălui». Origen (sec.~III, \textit{Commentarii in Matthaeum} ad loc.) comenta că numele «Iisus» apărea în fața lui «Baraba» în manuscrise vechi, dar că mulți copiști l-au eliminat — considerând nepotrivit ca un criminal să poarte același nume cu Mântuitorul.
