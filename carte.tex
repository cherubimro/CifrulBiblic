...
\item \textbf{(3) Auto-oglindă}: cuvinte cu iso(W) = inversat\_iso(W) --- palindromice sub inversare.
\end{itemize}
...
\paragraph*{Test 3 --- Auto-oglindă (iso = inversat\_iso).} 25 forme NT care rămân invariante sub inversare. Cele mai semnificative:
